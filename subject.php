...
<html lang="en">
  <head>
    ...
    <title>Online Examination | Subject</title>
  ...
  <body class="nav-md">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form class="form-horizontal form-label-left" action="subject_db.php" method="post">
                    <!--Hidden field -->
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="sub-name"><b>Subject Name</b> <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="sub-name" name="sub-name" required="required" class="form-control ">
                      </div>
                    </div>
                  ...
                  <div class="x_content">
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <?php
                          $sql = "SELECT subject.*, course.name as course_name 
                          FROM subject 
                          JOIN course ON subject.course_id = course.id";
                          $stmt = $pdo->prepare($sql);
                          $stmt->execute();
                        ...
                        <tbody>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" last"><img src="assets/images/edit.png" onclick="loadFormData(<?= $row->id ?>,'<?= $row->course_id?>','<?= $row->sub_name ?>')" style="cursor: pointer;"/>
                            
                            <td class=" last"><a href="subject_db.php?sid=<?= $row->id ?>&formaction=delete" onclick="return confirm_del()"><img src="assets/images/delete.png" onclick="return confirm_del(<?= $row->id ?>)" /></a>
                            </td>
                          </tr>
                          <?php
                            }
    ...
    <script>
      ...
      function loadFormData(sid, courseId, name) {
      document.getElementById("sid").value = sid;
